...
smatrader = st.SMACTrader("oanda.cfg", "EUR_USD", "5min", smas=sma_updater[0], smal=sma_updater[1], units=500000)
...
smau = smabt.SMABacktester(instrument='EUR_USD', start=str(datetime.now() - timedelta(days=1))[:-7],
